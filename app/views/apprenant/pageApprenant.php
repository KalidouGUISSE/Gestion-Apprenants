...
<style>
    ...
    .importer{
        background-color:rgb(15, 140, 142);
    }
</style>
    ...
    <main class="main-content">
        ...
        <section class="content view-list">
            ...
            <div class="promo-content-list-bar">
                ...
                <a href="index.php?route=page_ajout_apprenant" class="importer" style="color:#fff; border-radius:5px;"  >
            ...
            <table class="promo-table">
                <thead>
                    <tr>
                        <th colspan="4" style="padding: 0;">
                            <a href="index.php?route=apprenants" style="display: block; width: 100%; padding: 10px; background: #e0e0e0; text-align: center; color: blac; font-size: 20p; font-weight: bold; ">
                                LISTE RETENUEE
                            </a>
                        </th>
                        <th colspan="4" style="padding: 0;">
                            <a href="index.php?route=apprenants_attente" style="display: block; width: 100%; padding: 10px; background: #f5f5f5; text-align: center; color: red; font-size: 20p; font-weight: bold;">
                                LISTE d'ATTENTE
                            </a>
                        </th>
                    </tr>
                ...
                <tbody>
                        ...
                        <?php else: ?>
                    <tr>
                    <td colspan="7">Aucune Apprenant trouvée.</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
